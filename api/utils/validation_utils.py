...
class CreateDatasetReq(Base):
    ...
    control_permission: Annotated[Literal["me", "team"], Field(default="me", min_length=1, max_length=16)]
    view_permission: Annotated[Literal["me", "team", "all"], Field(default="me", min_length=1, max_length=16)]
